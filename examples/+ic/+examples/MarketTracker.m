...
searchBar.style("> *", "flex", "1", "maxWidth", "300px");
...
tbl.style(".ic-tbl__header", ...
    "backgroundColor", "#0d0e14", ...
    "borderBottom", "2px solid #3b82f6");
tbl.style(".ic-tbl__hcell", ...
...
tbl.style(".ic-tbl__cell", ...
    "fontFamily", "'JetBrains Mono', 'Fira Code', 'Consolas', monospace", ...
    "fontSize", "12px", ...
    "color", "#e2e8f0");
tbl.style(".ic-tbl__row:hover", ...
    "backgroundColor", "rgba(59,130,246,0.06)");
tbl.style(".ic-tbl__row--selected", ...
    "backgroundColor", "rgba(59,130,246,0.12)", ...
    "boxShadow", "inset 3px 0 0 #3b82f6");
tbl.style(".ic-tbl__row--striped", ...
    "backgroundColor", "rgba(255,255,255,0.015)");

% pinned symbol column: subtle border
tbl.style(".ic-tbl__cell--pinned", "borderRight", "1px solid #1e293b");
tbl.style(".ic-tbl__hcell--sticking", "borderRight", "1px solid #1e293b");

% row number column
tbl.style(".ic-tbl__cell--rownum", "color", "#e2e8f0", "fontSize", "10px");
