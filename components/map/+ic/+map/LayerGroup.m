classdef LayerGroup < ic.map.Layer & ic.core.Container
    % groups map layers so they can be toggled, added, or removed as a unit.
    % Children added to this group are rendered on the group's Leaflet
    % LayerGroup instead of the root map.
    ...
    methods
        function this = LayerGroup(props)
            arguments
