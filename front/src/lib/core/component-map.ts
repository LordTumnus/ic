...
const componentMap: Record<string, () => Promise<unknown>> = {
  ...
  'ic.Accordion': modules['../components/layout/accordion/Accordion.svelte'],
  'ic.accordion.AccordionPanel': modules['../components/layout/accordion/AccordionPanel.svelte'],
